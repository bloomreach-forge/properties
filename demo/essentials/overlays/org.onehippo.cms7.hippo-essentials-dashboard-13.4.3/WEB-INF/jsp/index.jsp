...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/hippo-theme/dist/css/main.css?v=13.4.3"/>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/angular-ui-tree/dist/angular-ui-tree.css?v=13.4.3"/>
  <script type="application/javascript">
    window.SERVER_URL = '<%=request.getScheme()+"://"+request.getServerName()+':'+request.getServerPort()%>';
  </script>

  <%-- HIPPO THEME DEPS --%>
  <script src="${pageContext.request.contextPath}/components/jquery/dist/jquery.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/chosen-js/chosen.jquery.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/angular/angular.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/angular-animate/angular-animate.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/angular-aria/angular-aria.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/angular-chosen-localytics/dist/angular-chosen.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/angular-ui-bootstrap/dist/ui-bootstrap-tpls.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/js/lib/angular-ui-tree.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/hippo-theme/dist/js/main.js?v=13.4.3"></script>

  <%-- ESSENTIALS --%>
  <script src="${pageContext.request.contextPath}/components/angular-ui-router/release/angular-ui-router.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/components/angular-sanitize/angular-sanitize.js?v=13.4.3"></script>

  <script src="${pageContext.request.contextPath}/js/app.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/js/routes.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/js/directives.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/js/controllers.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/dashboard/api/services.js?v=13.4.3"></script>
  <script src="${pageContext.request.contextPath}/dashboard/api/directives.js?v=13.4.3"></script>
...
<div class="hidden" ng-include="'${pageContext.request.contextPath}/components/hippo-theme/dist/images/hippo-icon-sprite.svg?v=13.4.3'"></div>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${pageContext.request.contextPath}"
         title="version: 13.4.3">Essentials</a>
